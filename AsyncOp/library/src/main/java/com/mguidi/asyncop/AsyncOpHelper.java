...
public class AsyncOpHelper {
    ...
    public static final String SAVED_ID_HELPER = "com.mguidi.asyncop:id_helper";
    public static final String SAVED_ID_REQUEST = "com.mguidi.asyncop:id_request";
    public static final String SAVED_PENDING_REQUESTS = "com.mguidi.asyncop:pending_requests";
    public static final String SAVED_MAP_PENDING_REQUESTS_ACTION = "com.mguidi.asyncop:map_pending_requests_action";
